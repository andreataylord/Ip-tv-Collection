...
<!-- STATS:START -->
> **Last Checked:** 2026-08-08 05:34 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **1842** | 30.6% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **128** | 2.1% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **597** | 9.9% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3459** | 57.4% | Server offline, timed out, or returning errors globally. |
