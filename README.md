...
<!-- STATS:START -->
> **Last Checked:** 2026-07-18 01:17 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2938** | 41.2% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **151** | 2.1% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **522** | 7.3% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3517** | 49.3% | Server offline, timed out, or returning errors globally. |
