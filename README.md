...
<!-- STATS:START -->
> **Last Checked:** 2026-07-05 01:21 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2950** | 35.5% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **784** | 9.4% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **396** | 4.8% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **4191** | 50.4% | Server offline, timed out, or returning errors globally. |
