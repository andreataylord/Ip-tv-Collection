...
<!-- STATS:START -->
> **Last Checked:** 2026-09-25 03:18 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2241** | 34.4% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **128** | 2.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **637** | 9.8% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3506** | 53.8% | Server offline, timed out, or returning errors globally. |
