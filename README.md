...
<!-- STATS:START -->
> **Last Checked:** 2026-06-28 01:27 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2781** | 34.5% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **768** | 9.5% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **691** | 8.6% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3822** | 47.4% | Server offline, timed out, or returning errors globally. |
