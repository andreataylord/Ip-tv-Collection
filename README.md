...
<!-- STATS:START -->
> **Last Checked:** 2026-09-01 04:39 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2164** | 34.0% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **128** | 2.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **675** | 10.6% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3398** | 53.4% | Server offline, timed out, or returning errors globally. |
