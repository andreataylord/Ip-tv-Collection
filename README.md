...
<!-- STATS:START -->
> **Last Checked:** 2026-07-17 01:18 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2938** | 37.4% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **786** | 10.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **492** | 6.3% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3645** | 46.4% | Server offline, timed out, or returning errors globally. |
