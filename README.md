...
<!-- STATS:START -->
> **Last Checked:** 2026-08-11 01:03 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **1719** | 28.5% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **128** | 2.1% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **559** | 9.3% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3620** | 60.1% | Server offline, timed out, or returning errors globally. |
