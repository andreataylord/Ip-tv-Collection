...
<!-- STATS:START -->
> **Last Checked:** 2026-08-29 07:34 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2161** | 34.0% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **128** | 2.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **678** | 10.7% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3389** | 53.3% | Server offline, timed out, or returning errors globally. |
