...
<!-- STATS:START -->
> **Last Checked:** 2026-09-06 02:07 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2217** | 33.9% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **128** | 2.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **714** | 10.9% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3487** | 53.3% | Server offline, timed out, or returning errors globally. |
