...
<!-- STATS:START -->
> **Last Checked:** 2026-06-25 01:52 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2880** | 36.4% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **769** | 9.7% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **569** | 7.2% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3691** | 46.7% | Server offline, timed out, or returning errors globally. |
