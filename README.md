...
<!-- STATS:START -->
> **Last Checked:** 2026-07-11 05:59 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **3028** | 38.3% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **791** | 10.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **487** | 6.2% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3595** | 45.5% | Server offline, timed out, or returning errors globally. |
