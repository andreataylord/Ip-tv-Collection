...
<!-- STATS:START -->
> **Last Checked:** 2026-07-13 01:11 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2966** | 37.5% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **791** | 10.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **489** | 6.2% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3655** | 46.3% | Server offline, timed out, or returning errors globally. |
