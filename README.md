...
<!-- STATS:START -->
> **Last Checked:** 2026-09-01 07:42 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2263** | 34.5% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **128** | 2.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **724** | 11.0% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3449** | 52.5% | Server offline, timed out, or returning errors globally. |
