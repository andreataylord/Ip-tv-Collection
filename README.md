...
<!-- STATS:START -->
> **Last Checked:** 2026-09-26 07:14 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2213** | 34.1% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **128** | 2.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **659** | 10.1% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3494** | 53.8% | Server offline, timed out, or returning errors globally. |
