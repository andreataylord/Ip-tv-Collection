...
<!-- STATS:START -->
> **Last Checked:** 2026-07-01 02:05 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2958** | 36.4% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **768** | 9.5% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **497** | 6.1% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3899** | 48.0% | Server offline, timed out, or returning errors globally. |
