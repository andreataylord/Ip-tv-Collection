...
<!-- STATS:START -->
> **Last Checked:** 2026-08-24 12:34 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2140** | 33.6% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **128** | 2.0% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **683** | 10.7% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3424** | 53.7% | Server offline, timed out, or returning errors globally. |
