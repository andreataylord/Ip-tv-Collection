...
<!-- STATS:START -->
> **Last Checked:** 2026-06-24 02:12 AM (BST)
> *Next check scheduled for 12:00 AM tonight.*

| Status | Count | Percentage | Description |
| :--- | :---: | :---: | :--- |
| 🟢 **Active** | **2883** | 36.5% | Online and streaming globally. |
| 🔵 **Local ISP / BDIX** | **769** | 9.7% | Local Bangladeshi ISP servers. Working perfectly if you are on that ISP. |
| 🟡 **Geo-Blocked** | **584** | 7.4% | Stream is online but restricted to specific countries. |
| 🔴 **Down / Error** | **3673** | 46.4% | Server offline, timed out, or returning errors globally. |
